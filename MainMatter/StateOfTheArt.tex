...
\begin{figure}
     \centering
     \subfloat[]{\includegraphics[width=0.5\linewidth]{resolution.pdf}\label{fig:resolution}}
     \subfloat[]{\includegraphics[width=0.5\linewidth]{intrusiveness.pdf}\label{fig:intrusiveness}}
...
\begin{figure}[h!tb]
\centering\includegraphics[scale=0.56]{ToF.pdf}
...
\begin{figure}[h!tb]
\centering\includegraphics[scale=0.45]{trilateration.pdf}
...
\begin{figure}[h!tb]
\centering\includegraphics[scale=0.4]{minMax.pdf}
...
\begin{figure}
     \centering
     \subfloat[]{\includegraphics[scale=0.32]{protocololdwf.pdf}\label{fig:wfips_od}}\\[-2ex]
     \subfloat[]{\includegraphics[scale=0.32]{protocololdbt.pdf}\label{fig:btips_od}}
...
% \begin{figure}
% \centering
% \sidesubfloat[]{\includegraphics[scale=0.33]{protocololdwf.pdf}\label{fig:wfips_od}}
% \newline
% \sidesubfloat[]{\includegraphics[scale=0.33]{protocololdbt.pdf}\label{fig:btips_od}}
% \caption[Traditional Indoor Positioning Systems applied for occupancy monitoring.]{Traditional Indoor Positioning Systems applied for occupancy monitoring. \protect\subref{fig:wfips_od} Refers to common WiFi based IPS, \protect\subref{fig:btips_od} refers to common Bluetooth based IPS used for real-time monitoring.}
% \label{fig:wfips_btips}
% \end{figure}
